...
WHERE
    ...
    echo 'You are about to set the topic you have created back to an un-resolved state. The last post marked as resolved is as followed: <p></p>';
 ...
 <?php 
        ...
        if(isset($_POST['submit'])){
            if(isset($_POST['myCheckBox'])){
                ...
                //sql stuff
                 $sql = "UPDATE posts SET post_rez = '0' WHERE post_id = '" . $post_id . "';";
        ...
        {
            echo 'Your topic has been marked as Un-Resolved. Check out <a href="/forum/posts.php?id=' . htmlentities($_GET['topicid']) . '">the topic</a>.';
        }
